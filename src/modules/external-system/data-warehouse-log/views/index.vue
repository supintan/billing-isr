          ...
          <b-card class="card bg-white m-0 p-1 col-12 mb-2">
            <b-input-group size="md">
              ...
              <b-input-group-append>
                <b-button
                  :disabled="!filter"
                  @click="filter = ''; this.getDataTable()"
    ...
    >
      ...
      <div v-show="getDetailUserSuccessed">
        ...
        <b-form-group label="Sumber">
          <label class="form-control" readonly>{{ detailUser.data4 }}</label>
        </b-form-group>
        <b-form-group label="Tujuan">
          <label class="form-control" readonly>{{ detailUser.data6 }}</label>
        </b-form-group>
        <b-form-group label="Request" label-size="auto">
        <textarea class="mb-2 mb-lg-0 form-control" v-model="detailUser.data3" readonly></textarea>
        </b-form-group>
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: 'data3', label: 'Sumber' },
        { key: 'data4', label: 'Tujuan' },
        { key: 'id', label: 'Aksi' },
      ],
      items: [],
      itemss: [
        {
          no: 1,
          data1: 'https://datawarehouse/api',
          data2: '29 oktober 2021',
          data3: 'Test Sumber',
          data4: 'Test Tujuan'
        },
      ],
  ...
  methods: {
    ...
    async detail(idUser) {
      ...
      await axios({
        url: URLServices.externalDatawareHouseLog.get,
        method: 'get',
        params: {
          request_id: uuid.v4(),
          id: idUser,
    ...
    getDataTable() {
      ...
      axios({
        url: URLServices.externalDatawareHouseLog.index,
        params: param,
        method: 'get',
        headers: {
          Authorization: `${TokenType} ${getToken()}`,
