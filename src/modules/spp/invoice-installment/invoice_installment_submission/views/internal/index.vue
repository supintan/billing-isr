  ...
  <div>
    <b-row class="mb-2">
      <b-col class="text-right">
        <!-- <b-button variant="light" :to="{ name: 'add-installment-submission' }">
            ...
            <template #cell(action)="data">
              <b-button
                ...
                :to="{
                  ...
                  params: {
                    idSubmision: data.item.installment_submission_id,
                    idInstallment: data.item.installment_id,
                  }
                }"
              >
...
export default {
  ...
  methods: {
        ...
        await axios({
          ...
          .then(result => {
            if (result.data.response_code === '00') {
              const succesMessage = `Berhasil update regulasi c-value baru.`
    ...
    getDataTable() {
      ...
      axios({
        url: URLServices.installment_submission.index,
        params: param,
        method: 'get',
        headers: {
          Authorization: `${TokenType} ${getToken()}`,
        ...
        .catch(() => {
          ...
          CustomNotification.notif('danger', 'Danger', succesMessage)
        })
    },
