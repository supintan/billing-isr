...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        { key: 'field1', label: 'No' },
        { key: 'field2', label: 'Deskripsi' },
        { key: 'field3', label: 'Tanggal Transaksi' },
        { key: 'field4', label: 'Metode Pembayaran' },
        { key: 'field5', label: 'Status Pembayaran' },
        { key: 'field6', label: 'Jumlah Pembayaran' },
        { key: 'field7', label: 'Total' },
        { key: 'field8', label: 'Aksi' },
      ],
      items: [],
      selectedUser: [],
      title: {},
      ...
      this.items = [
        {
          field1: '1',
          field2: '10920192',
          field3: '09 Januari 2021 09:00:10',
          field4: 'SPP Terbit',
          field5: '-',
          field6: 'Rp. 100.000.000',
        },
        {
          field1: '2',
          field2: '10182021',
          field3: '10 Januari 2021 11:29:00',
          field4: 'SPP Terbit',
          field5: '-',
          field6: 'Rp. 200.000.000',
        },
        {
          field1: '3',
          field2: '10920192',
          field3: '19 Januari 2021 14:10:10',
          field4: 'Pembayaran',
