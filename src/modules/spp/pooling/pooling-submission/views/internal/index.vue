            ...
            <template #cell(action)="data">
              <b-button
                ...
                :to="{
                  ...
                  params: {
                    idpooling: data.item.pooling_id,
                    idpoolingsubmission: data.item.pooling_submission_id,
                    idappealpoolingsubmission: data.item.pooling_appeal_submission_id,
                    name: data.item.client_name,
                    status: data.item.status
                  }
                }"
                v-if="$can('store', 'isr_pooling_submission')"
              >
...
export default {
  ...
  methods: {
    ...
    getDataTable() {
      ...
      axios({
        url: URLServices.hkppoolingsubmission.index,
        params: param,
        method: 'get',
        headers: {
          Authorization: `${TokenType} ${getToken()}`,
