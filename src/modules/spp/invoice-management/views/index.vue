...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        { key: 'field1', label: 'No.' },
        { key: 'field2', label: 'Client' },
        { key: 'field3', label: 'Aplikasi' },
        { key: 'field4', label: 'No. SPP' },
        { key: 'field5', label: 'Nilai' },
        { key: 'field6', label: 'Tgl. Jatuh Tempo' },
    ...
    getDataTable() {
      ...
      this.items = [
        ...
        },
        {
          ...
          field3: '1212121',
          field4: '1001011',
          field5: 'Rp. 300.000.000',
          field6: '20 September 2021',
          action: '1',
        },
      ]
      this.isBusy = false
