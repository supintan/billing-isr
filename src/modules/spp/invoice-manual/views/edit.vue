...
export default {
  ...
  methods: {
    ...
    createRequestVariable() {
      ...
      if (lengthRole === 0) {
        const choose = 'Anda harus memilih satu role'
        CustomNotification.notif('warning', choose)
        ...
        await axios({
          ...
          .then(result => {
            if (result.data.response_code === '00') {
              const successMessage = 'Berhasil menambahkan user baru'
              CustomNotification.notif('success', successMessage)
