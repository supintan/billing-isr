        ...
        <b-row class="mb-1">
          <b-col lg="10" sm="12">
            ...
            <b-form-group label-cols="2" label="File Surat Permohonan" >
              <button data-v-aa799a9e="" type="button" class="btn mr-1 btn-info" style="position: relative;" @click="onClick()"> Download Dokumen </button>
            </b-form-group>
        ...
        <b-col lg="12" sm="10">
          ...
          <b-col lg="12" sm="10">
            <b-form-group label-cols="3" label="File Surat Keputusan" >
              <button data-v-aa799a9e="" type="button" class="btn mr-1 btn-info" style="position: relative;" @click="onClickApprove()"> Download File </button>
            </b-form-group>
          </b-col>
          <b-col lg="12" sm="12">
...
export default {
  ...
  methods: {
    ...
    async detail() {
      ...
      await axios({
        url: URLServices.depositSubmission.show,
        method: 'get',
        params: {
          request_id: uuid.v4(),
          id: this.idDepositUsageSubmission,
