  ...
  <div>
    <b-row class="mb-4">
      <b-col class="text-right">
        <b-button variant="light" :to="{ name: 'add-permohonan-deposit' }" hidden class="mr-1 text-primary">
      ...
      <b-col cols="12">
        <b-card no-body class="p-0 mb-4">
          ...
          >
            ...
            <template #cell(deposit_usage_id)="data">
              <b-button
                ...
                :to="{
                  ...
                  params: {IddetailDeposit: data.item.deposit_usage_id,idClientDeposit: data.item.client_id,idDepositUsageSubmission: data.item.deposit_usage_submission_id },
                }"
              >
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: 'deposit_usage_id', label: 'Aksi' },
      ],
      items: [],
      selectedUser: [],
      title: {},
  ...
  methods: {
    ...
    getDataTable() {
      ...
      axios({
        url: URLServices.depositSubmission.index,
        params: param,
        method: 'get',
        headers: {
        ...
        .catch(() => {
          ...
          // this.showTable = false
					...
					CustomNotification.notif('danger', 'Danger', responseMessage)
        })
    },
