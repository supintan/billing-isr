  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: 'appeal_due_date', label: 'Tgl. Jatuh Tempo baru' },
        { key: 'id', label: 'Aksi' },
      ],
      items: [],
      // itemss: [
      //   { 
      //     no: '1',
      //     appeal_letter_number: 'TESTP001',
      //     upload_date_time: '29 oktober 2021',
      //     verification_date_time: '29 oktober 2021',
      //     verification_employee_name: 'Petugas verifikasi',
      //     review_date_time: '29 oktober 2021',
      //     reviewer_employee_name: 'Petugas review',
      //     review_status: 'DISETUJUI',
      //     invoice_number: 'SPP002',
      //     invoice_total_amount: 'Rp. 15.000.000.000',
      //     appeal_due_date: '29 november 2021',
      //     original_due_date: '30 november 2021'
      //   }
      // ],
      showTable: false,
    }
